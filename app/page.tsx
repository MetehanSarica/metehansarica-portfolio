          ...
          <RevealOnScroll>
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-slate-300">
                ...
                focused on{" "}
                <span className="font-semibold text-slate-100">
                  line-of-business desktop applications, SQL Server and DevExpress UI
                </span>
                ...
                <RevealOnScroll delay={0}>
                  <div className="rounded-2xl border border-slate-800 bg-slate-950/60 p-4 text-sm text-slate-300">
                    ...
                    <p>
                      ...
                      smart inventory &amp; product management system built with
                      .NET 8, DevExpress and SQL Server. I enjoy experimenting
                      with{" "}
                      <span className="font-semibold">
                        desktop app architecture
                      </span>
                      , automation workflows and integrating AI into existing tools
                ...
                <RevealOnScroll delay={0.15}>
                  <div className="rounded-2xl border border-slate-800 bg-slate-950/60 p-4 text-sm text-slate-300">
                    ...
                    <ul className="list-disc space-y-1 pl-5 text-xs text-slate-300">
                      <li>
                        Work with C#, .NET, DevExpress and SQL Server in
                        real-world projects
                      </li>
                      <li>
        ...
        <section id="projects" className="py-14">
          <RevealOnScroll>
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-slate-300">
                A selection of projects that represent how I like to build
                software.
              </p>
              ...
              <div className="mt-6 space-y-4">
                ...
                <RevealOnScroll delay={0}>
                  <article className="rounded-2xl border border-slate-800 bg-slate-950/80 p-4 text-sm">
                    ...
                    <p className="mt-2 text-xs text-slate-300">
                      Storiva is a smart inventory and product management system
                      built with .NET 8, DevExpress and SQL Server. It focuses on
                      stock tracking, product management, role-based access and
                      future AI-assisted features to help small businesses manage
                    ...
                    <ul className="mt-2 list-disc space-y-1 pl-4 text-xs text-slate-300">
                      ...
                      <li>
                        Architected to integrate AI features (Gemini API) for
                ...
                <RevealOnScroll delay={0.12}>
                  <article className="rounded-2xl border border-slate-800 bg-slate-950/80 p-4 text-sm">
                    ...
                    <p className="mt-2 text-xs text-slate-300">
                      ...
                      files and generates concise, structured study notes using
                      Gemini AI. It handles file parsing, progress tracking and
                      PDF generation in a single workflow.
                    </p>
                    <ul className="mt-2 list-disc space-y-1 pl-4 text-xs text-slate-300">
                ...
                <RevealOnScroll delay={0.24}>
                  <article className="rounded-2xl border border-slate-800 bg-slate-950/80 p-4 text-sm">
                    ...
                    <p className="mt-2 text-xs text-slate-300">
                      A modern, responsive portfolio website to showcase my
                      projects, skills and experience as a Junior .NET Developer.
                      Deployed on Netlify with a custom domain and Google
                      Analytics integration to track visitors and engagement.
                    </p>
                    <ul className="mt-2 list-disc space-y-1 pl-4 text-xs text-slate-300">
